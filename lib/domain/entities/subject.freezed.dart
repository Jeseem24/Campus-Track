...
mixin _$Subject {
  ...
  int get color => throw _privateConstructorUsedError; // Default Blue
...
class _$SubjectImpl implements _Subject {
  ...
  @override
  String toString() {
    return 'Subject(id: $id, name: $name, code: $code, color: $color, credits: $credits, semesterId: $semesterId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, code, color, credits, semesterId);
